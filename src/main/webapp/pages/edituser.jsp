...
<html lang="pt-br">
            ...
            <div class="user-wrapper">
                ...
                <form action="UserController" method="POST">
                    ...
                    <div style="display: flex; flex-direction: row;">
                        <input type="submit" class="button-edit" value="Confirmar">
                        <input type="button" class="button-edit" onclick="cancel()" value="Cancelar" />
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        function cancel() {
            window.location.href = "pages/userpage.jsp";
