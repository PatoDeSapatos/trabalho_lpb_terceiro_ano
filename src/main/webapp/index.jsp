<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    import="model.GameVO, java.util.ArrayList"
%> 
...
<body>
    <header>
        <nav>
            <a href="./pages/gameForm.html?operation=register"> 
    ...
    <div class="recent-games-wrapper">
        ...
        <div class="games-wrapper">
            <%
                ...
                GameVO game2 = new GameVO("2", "Dark Souls II", "https://assets.nintendo.com/image/upload/f_auto/q_auto/dpr_1.5/f_auto/q_auto/dpr_1.5/f_auto/q_auto/dpr_1.5/f_auto/q_auto/dpr_1.5/c_scale,w_400/ncom/pt_BR/games/switch/c/celeste-switch/description-image", "https://assets.nintendo.com/image/upload/c_fill,w_1200/q_auto:best/f_auto/dpr_2.0/ncom/software/switch/70010000006442/691ba3e0801180a9864cc8a7694b6f98097f9d9799bc7e3dc6db92f086759252", 0, 250, 100, 25, 5);
                ...
                for (GameVO game : games) {
                    out.println("<div class='game-section'>");
                        out.println("<figure>");
                            ...
                            out.println("<a href='./pages/gamepage.jsp?game=" + game.getId() + "' />");
